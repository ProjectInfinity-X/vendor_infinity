...
ALARM_PATH := vendor/infinity/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/infinity/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/infinity/prebuilt/common/media/audio/ringtones
